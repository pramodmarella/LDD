...
#define DEVICE_NAME "simple_device"//device name
#define BUFFER_SIZE 1024//size of the buffer

static int major_number;//declaration of global variable
static char device_buffer[BUFFER_SIZE];//declaration of global array
static int open_count = 0;//declaration of global variable for counting
...
// calculator 
 int num=0,i,p,j,num1=0,num2=0;
char n;

	for(i=0,num=0;device_buffer[i];i++)
	{
